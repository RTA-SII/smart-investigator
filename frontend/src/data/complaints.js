...
function buildOne(i, fresh = false) {
  ...
  const complaint = {
    ...
    ai,
    evidence: [
      { kind: "image", label: "In-cab camera still", time: receivedAt, frame: frameFor("In-cab camera still", i, type) },
      { kind: "image", label: "Forward road view", time: receivedAt, frame: frameFor("Forward road view", i, type) },
      { kind: "video", label: "Trip recording", time: receivedAt, frame: frameFor("Trip recording", i, type) },
...
function fromRta(c, i) {
  ...
  return {
    ...
    incomplete: false,
    evidence: [
      { kind: "image", label: "In-cab camera still", time: c.receivedAt, frame: frameFor("In-cab camera still", i, c.type) },
      { kind: "image", label: "Forward road view", time: c.receivedAt, frame: frameFor("Forward road view", i, c.type) },
      { kind: "video", label: "Trip recording", time: c.receivedAt, frame: frameFor("Trip recording", i, c.type) },
